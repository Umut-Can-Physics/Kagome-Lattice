...
co, _ = plot_square_lattice(N_Site, Nx, Ny, path="./Braiding_Data/square_lattice.png")
...
#println("**Parameters**")
#println(ParameterInfo(NPin, pn, Nx, Ny, p, q))
...
PATH1 = path_1
PATH2 = path_2
ψ_first, ψ_mat, Converge, ψ_op, imp_data, ψ_mat_list, ϵ_list, V0_step_list = get_phases(UPsi_first, V, Vrand, PATH1, PATH2, STEP, HHubbard, Number_MB_Operator_List, Degeneracy)
